...
public class BuildHelloVR
{
    ...
    [UnityEditor.MenuItem("WaveVR/Build Android APK/Build wvr_unity_hellovr.apk")]
    static void BuildApk()
    {
        BuildApk(null, false);
    }

    [UnityEditor.MenuItem("WaveVR/Build Android APK/Build+Run wvr_unity_hellovr.apk")]
    ...
    public static void BuildApk(string destPath, bool run)
    {
        ...
        BuildApkInner("hellovr.unity", "wvr_unity_hellovr.apk", destPath, run, levels);
    }
